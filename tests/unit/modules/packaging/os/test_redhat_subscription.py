...
from ansible_collections.ansible.unix.plugins.modules import redhat_subscription
...
def patch_redhat_subscription(mocker):
    ...
    """
    mocker.patch('ansible_collections.ansible.unix.plugins.modules.redhat_subscription.RegistrationBase.REDHAT_REPO')
    mocker.patch('ansible_collections.ansible.unix.plugins.modules.redhat_subscription.isfile', return_value=False)
    mocker.patch('ansible_collections.ansible.unix.plugins.modules.redhat_subscription.unlink', return_value=True)
    mocker.patch('ansible_collections.ansible.unix.plugins.modules.redhat_subscription.AnsibleModule.get_bin_path',
